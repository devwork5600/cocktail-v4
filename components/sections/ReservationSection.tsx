  ...
  return (
    <section id="privatization" className="py-24 md:py-40 relative scroll-mt-32">
      ...
      <motion.div
        ...
        className="max-w-3xl mx-auto px-6 text-center relative z-10 flex flex-col gap-8"
      >
          ...
          {isOpen && (
            ...
            >
              <form
                ...
                className="text-left flex flex-col gap-6 pt-4 pb-2 gold-border rounded-md bg-surface-container p-8 md:p-10 mt-2"
              >
